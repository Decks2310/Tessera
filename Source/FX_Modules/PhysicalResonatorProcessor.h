...
// Ensure the dedicated AllpassTPTFilter header is available
...
private:
    ...
    // FIX: Switched to the dedicated juce::dsp::AllpassTPTFilter for JUCE 8 compatibility.
    // This resolves the 'allpass' configuration error and allows Q control.
    using DispersionFilter = juce::dsp::AllpassTPTFilter<float>;
